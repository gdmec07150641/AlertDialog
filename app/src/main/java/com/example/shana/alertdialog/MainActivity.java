package com.example.shana.alertdialog;
...
public class MainActivity extends Activity {
    ...
    public void dialog2(){
        ...
        dialog.setButton(DialogInterface.BUTTON_POSITIVE,"夏娜",listener);
        dialog.setButton(DialogInterface.BUTTON_NEGATIVE,"miku",listener);
        dialog.setButton(DialogInterface.BUTTON_NEUTRAL,"真白",listener);
        dialog.show();
    }
    public void dialog3(){
        dialog=new AlertDialog.Builder(this).create();
        dialog.setTitle("请输入");
        dialog.setMessage("你喜欢我么?");
    ...
    public void dialog4(){
    final String item[]=new String[]{"夏娜","真白","miku"};
    ...
    public void dialog5(){
        final String item[]=new String[]{"a","b","c"};
        final boolean bSelect[]=new boolean[item.length];
